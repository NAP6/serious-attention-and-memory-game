...
import contrys from "./contrys.js";
    ...
    if (is_valid) {
      ...
      if (obj.password == obj.confirm_password) {
        if (await LogController.search_email(obj.email)) {
          ...
          var id = await LogController.register(
            obj.email,
            obj.password,
            user_is_admin ? "Administrator" : "Patient"
          );
          if (id) {
            ...
            if (user_is_admin) {
              ...
              var is_registed = await PatientController.insert(
                patient,
                id,
                obj.group
              );
