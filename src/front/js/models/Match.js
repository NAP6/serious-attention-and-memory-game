class Match {
    ...
    register_eye_position(x, y) {
        this.eye_traking.push(new eye_focus_point(x, y));
    }
}
...
class MatchEvent {
    constructor(level_id, item_tag, item_index, element_top, element_left, element_width, element_height, vewport_width, vewport_height, is_correct,x_eye_position, y_eye_position) {
